            ...
            <div className="space-y-4 pt-6 text-center md:p-8 md:text-left">
              <figcaption className="font-medium">
                ...
                <aside className="mt-2 flex justify-around gap-2 text-sm text-gray-600 dark:text-gray-400 Psm:flex-col">
                  ...
                  {props.user.profile.links.personalWebsite !== "" && (
                    <span>
                      <i className="profile-card-loc_joined">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <a
                        href={`${props.user.profile.links.personalWebsite}`}
                        target="_blank"
                  ...
                  {/* Youtube icon*/}
                  {props.user.profile.links.youtube !== "" && (
                    <span>
                      <i className="profile-card-loc_joined">
                        <svg
                          width="24"
                      ...
                      <a
                        href={`${props.user.profile.links.youtube}`}
                        target="_blank"
                        className="text-sky-500 hover:text-sky-300"
                      >
                        YouTube
                  ...
                  {/* instagram icon*/}
                  {props.user.profile.links.instagram !== "" && (
                    <span>
                      <i className="profile-card-loc_joined">
                        <svg
                          width="24"
                      ...
                      <a
                        href={`${props.user.profile.links.instagram}`}
                        target="_blank"
                        className="text-sky-500 hover:text-sky-300"
                      >
                        Instagram
                  ...
                  {/* twitter icon*/}
                  {props.user.profile.links.twitter !== "" && (
                    <span>
                      <i className="profile-card-loc_joined">
                        <svg
                          width="24"
                      ...
                      <a
                        href={`${props.user.profile.links.twitter}`}
                        target="_blank"
                        className="text-sky-500 hover:text-sky-300"
                      >
                        Twitter
                  ...
                  {/* Linkedin icon*/}
                  {props.user.profile.links.linkedin !== "" && (
                    <span>
                      <i className="profile-card-loc_joined">
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <a
                        href={`${props.user.profile.links.linkedin}`}
                        target="_blank"
                        className="text-sky-500 hover:text-sky-300"
                      >
                        Linkedin
